                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-lg-4">
                            ...
                            <input type="number" name="daily_price" id="daily_price" class="form-control" step="any" min="0" value="{{ old('daily_price', !empty($booking->daily_price_final) ? $booking->daily_price_final : $booking->vehicleDetails()->daily_rate) }}">
                        </div>
