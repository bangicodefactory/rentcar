...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('Enter vehicle name') }}" value="{{ old('name') }}" required>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="model" id="model" class="form-control" placeholder="{{ __('Enter model') }}" value="{{ old('model') }}" required>
        </div>
        <div class="form-group col-md-6">
            <label for="engine_type" class="form-label">{{ __('Engine Type') }}</label>
            <input type="text" name="engine_type" id="engine_type" class="form-control" placeholder="{{ __('Enter engine type') }}" value="{{ old('engine_type') }}" required>
        </div>
        <div class="form-group col-md-6">
            <label for="engine_no" class="form-label">{{ __('Engine Number') }}</label>
            <input type="text" name="engine_no" id="engine_no" class="form-control" placeholder="{{ __('Enter engine number') }}" value="{{ old('engine_no') }}">
        </div>
        <div class="form-group col-md-6">
            <label for="license_plate" class="form-label">{{ __('License Plate') }}</label>
            <input type="text" name="license_plate" id="license_plate" class="form-control" placeholder="{{ __('Enter license plate') }}" value="{{ old('license_plate') }}" required>
        </div>
        <div class="form-group col-md-6">
            <label for="registration_expiry_date" class="form-label">{{ __('Registration Expiry Date') }}</label>
            <input type="date" name="registration_expiry_date" id="registration_expiry_date" class="form-control" value="{{ old('registration_expiry_date') }}">
        </div>
        <div class="form-group col-md-6">
            <label for="daily_rate" class="form-label">{{ __('Daily Rate') }}</label>
            <input type="number" name="daily_rate" id="daily_rate" class="form-control" placeholder="{{ __('Enter daily rate') }}" value="{{ old('daily_rate') }}" required>
        </div>
        <div class="form-group col-md-6">
            <label for="year_of_ﬁrst_immatriculation" class="form-label">{{ __('Year of First Immatriculation') }}</label>
            <input type="number" name="year_of_ﬁrst_immatriculation" id="year_of_ﬁrst_immatriculation" class="form-control" placeholder="{{ __('Enter Year of First Immatriculation') }}" value="{{ old('year_of_ﬁrst_immatriculation') }}">
        </div>
        <div class="form-group col-md-6">
            ...
            <select name="gearbox" class="form-control hidesearch " id="gearbox" required>
                @foreach ($gearbox as $k => $val)
                    <option value="{{ $k }}" {{ old('gearbox') == $k ? 'selected' : '' }}>{{ $val }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-md-6">
            ...
            <select name="fuel_type" class="form-control hidesearch " id="fuel_type" required>
                @foreach ($fuelType as $k => $val)
                    <option value="{{ $k }}" {{ old('fuel_type') == $k ? 'selected' : '' }}>{{ $val }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" name="kilometers" id="kilometers" class="form-control" value="{{ old('kilometers') }}" required>
        </div>
        <div class="form-group col-md-6">
