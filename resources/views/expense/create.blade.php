...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="title" id="title" class="form-control" placeholder="{{ __('Enter Expense title') }}" value="{{ old('title') }}" required>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" name="amount" id="amount" class="form-control" placeholder="{{ __('Enter expense amount') }}" value="{{ old('amount') }}" required>
        </div>
        <div class="form-group col-md-6">
